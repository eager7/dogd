...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*dogutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *dogutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *dogutil.Block) error {
