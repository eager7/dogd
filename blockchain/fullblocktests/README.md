...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/eager7/dogd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/eager7/dogd/blockchain/fullblocktests
```
