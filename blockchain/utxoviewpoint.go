...
func (view *UtxoViewpoint) AddTxOut(tx *dogutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *dogutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *dogutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *dogutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *dogutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *dogutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *dogutil.Tx) (*UtxoViewpoint, error) {
