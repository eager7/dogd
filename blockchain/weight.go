...
func GetBlockWeight(blk *dogutil.Block) int64 {
...
func GetTransactionWeight(tx *dogutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *dogutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
